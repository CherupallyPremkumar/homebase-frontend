...
export function ReturnDetail({ id }: ReturnDetailProps) {
  ...
  return (
    <EntityDetailLayout
      breadcrumbs={[{ label: 'Returns', href: '/returns' }, { label: returnReq.id.slice(0, 8) }]}
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <Link href={`/orders/${returnReq.orderId}`} className="font-medium text-primary hover:underline">
                View Order
              </Link>
            </div>
          </CardContent>
