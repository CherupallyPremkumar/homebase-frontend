...
const TABS = [
  ...
  { href: '/receiving', label: 'Receive', icon: PackageOpen },
  { href: '/picking', label: 'Pick', icon: ClipboardList },
  { href: '/packing', label: 'Pack', icon: ScanBarcode },
  { href: '/cycle-count', label: 'Count', icon: RotateCcw },
  { href: '/bins', label: 'Bins', icon: MapPin },
];
