  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center gap-6 bg-slate-50">
      ...
      <div className="text-center">
        ...
        <p className="mt-1 text-sm text-gray-500">Your session has expired for security reasons.</p>
        <p className="mt-0.5 text-sm text-gray-400">Please sign in again to continue.</p>
      </div>
      <Link
        href="/login"
