...
export function FulfillmentDetail({ id }: FulfillmentDetailProps) {
  ...
  return (
    <EntityDetailLayout
      breadcrumbs={[{ label: 'Fulfillment', href: '/oms/fulfillment' }, { label: fulfillment.id.slice(0, 8) }]}
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <Link href={`/oms/orders/${fulfillment.orderId}`} className="font-medium text-primary hover:underline">
                View Order
              </Link>
            </div>
            <div className="flex justify-between">
