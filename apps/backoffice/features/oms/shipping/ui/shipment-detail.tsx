...
export function ShipmentDetail({ id }: ShipmentDetailProps) {
  ...
  return (
    <EntityDetailLayout
      breadcrumbs={[{ label: 'Shipments', href: '/oms/shipments' }, { label: shipment.trackingNumber || 'Pending' }]}
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <Link href={`/oms/orders/${shipment.orderId}`} className="font-medium text-primary hover:underline">
                View Order
              </Link>
            </div>
          </CardContent>
