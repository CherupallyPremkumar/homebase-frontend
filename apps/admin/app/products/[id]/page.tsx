...
import { useStmMutation, EntityDetailLayout, SectionSkeleton, ErrorSection, formatPriceRupees, CACHE_TIMES } from '@homebase/shared';
...
export default function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const mutation = useStmMutation<Product>({
    entityType: 'admin-product',
