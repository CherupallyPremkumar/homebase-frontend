                    ...
                    <tr>
                        <td style="padding:40px 32px;">
                            ...
                            <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.6;">
                                Please verify your email address by clicking the button below. This link will expire in ${linkExpirationFormatter(linkExpiration)}.
                            </p>
                            ...
                            <p style="margin:24px 0 0;font-size:13px;color:#9ca3af;line-height:1.5;">
                                If you didn't create an account on HomeBase, you can safely ignore this email.
                            </p>
                        </td>
                    </tr>
                    <tr>
